...
和 [11_自我反思 Reflexion](<11_自我反思 Reflexion.md>) 的关系可以单独放到 [14_ReAct 和 Reflexion的区别](<14_ReAct 和 Reflexion的区别.md>) 里。简单说，ReAct 关注当前任务中的“推理和行动循环”，Reflexion 更关注任务结束后的“经验反思和下次改进”。
...
- [14_ReAct 和 Reflexion的区别](<14_ReAct 和 Reflexion的区别.md>)：专门区分当前任务中的行动循环和任务后的经验学习。
