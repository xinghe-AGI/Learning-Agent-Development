...
- [17_Prompt Chaining 和 ReAct的区别](<17_Prompt Chaining 和 ReAct的区别.md>)：区分预先编排的流程和动态行动循环。
- [14_ReAct 和 Reflexion的区别](<14_ReAct 和 Reflexion的区别.md>)：区分当前任务中的行动循环和多次尝试之间的经验学习。
