...
- 如果多个 ToT 结果仍不稳定，可以再结合 [08_自我一致性 Self-Consistency](<08_自我一致性 Self-Consistency.md>) 或外部工具验证。
...
- [00_Prompt Engineering技术关系总览](<00_Prompt Engineering技术关系总览.md>)：把 CoT 和 ToT 放进推理增强层中，和自我一致性一起比较。
